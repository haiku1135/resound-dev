                ...
                <FormControl>
                  <div className="relative">
                    <Input
                      ...
                      disabled={isPending}
                    />
                    <div className="absolute inset-y-0 right-0 flex cursor-pointer items-center p-3 text-muted-foreground" onClick={() => {setPasswordVisibility1(!passwordVisibility1)}}>
                      {passwordVisibility1 ? (<EyeOffIcon className="w-5 h-5" />) : (<EyeIcon className="w-5 h-5" />)}
                    </div>
                  </div>
                </FormControl>
                <FormMessage />
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    ...
                    >
                      {passwordVisibility2 ? (<EyeOffIcon className="w-5 h-5" />) : (<EyeIcon className="w-5 h-5" />)}
                    </div>
                  </div>
                </FormControl>
              </FormItem>
